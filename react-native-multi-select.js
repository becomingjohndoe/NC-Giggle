...
export default class MultiSelect extends Component {
	static propTypes = {
		...
		styleDropdownMenu: stylePropType,
		styleDropdownMenuSubsection: stylePropType,
		styleInputGroup: stylePropType,
		styleItemsContainer: stylePropType,
		styleListContainer: stylePropType,
		styleMainWrapper: stylePropType,
		styleRowList: stylePropType,
		styleSelectorContainer: stylePropType,
		styleTextDropdown: stylePropType,
		styleTextDropdownSelected: stylePropType,
		styleTextTag: stylePropType,
	...
	_filterItemsFull = (searchTerm) => {
		...
		items.forEach((item) => {
			if (
				item[displayKey].toLowerCase().indexOf(searchTerm.trim().toLowerCase()) >= 0
			) {
				filteredItems.push(item);
			}
		});
